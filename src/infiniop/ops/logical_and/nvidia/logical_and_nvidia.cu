...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_BOOL:
        return _device_info->calculate<256, cuda::LogicalAndOp, bool>(_info, workspace, output, inputs, stream);
    case INFINI_DTYPE_I8:
        return _device_info->calculate<256, cuda::LogicalAndOp, int8_t>(_info, workspace, output, inputs, stream);
    default:
