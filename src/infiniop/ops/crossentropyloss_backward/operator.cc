...
#define GET(CASE, NAMESPACE)                                                                                    \
    case CASE:                                                                                                  \
        *size = reinterpret_cast<op::CrossEntropyLossBackWard::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
...
#define DELETE(CASE, NAMESPACE)                                                                     \
    case CASE:                                                                                      \
        delete reinterpret_cast<const op::CrossEntropyLossBackWard::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS
