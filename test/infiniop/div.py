...
def test(
    ...
    print(
        ...
        f"dtype:{InfiniDtypeNames[dtype]} inplace:{inplace}, Mode: {mode}"
    )

    div(c.torch_tensor(), a.torch_tensor(), b.torch_tensor(), mode)
    ...
    if PROFILE:
        # fmt: off
        profile_operation("PyTorch", lambda: div(c.torch_tensor(), a.torch_tensor(), b.torch_tensor(),mode), device, NUM_PRERUN, NUM_ITERATIONS)
